...
### ⚠️ 重要提醒：所有代码变更都必须同步文档！

当你进行任何功能开发、修改或新增时，**必须**同时更新以下文档：
...
4. **DevWheels架构思维导图.md** - 架构可视化
   - 添加新模块到思维导图
   - 更新功能完成状态
   - 调整架构层级关系

5. **CLAUDE.md** (本文件) - 开发指导
   - 更新使用示例
   - 同步开发规范
   - 添加新功能使用说明
...
- 修改类名、方法名、包路径时，必须全局搜索并更新所有文档
- 新增工具类或功能模块时，必须在所有相关文档中添加说明
- 删除功能时，必须从所有文档中移除相关内容
- 修改配置文件时，必须同步更新文档中的配置示例

#### 📝 文档维护责任

- **开发者责任**: 确保自己的代码变更同步到文档
- **Review责任**: 代码审查时必须检查文档同步情况
- **维护者责任**: 定期检查文档与代码的一致性
